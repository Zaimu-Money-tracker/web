...
export default function OverviewIncomes() {
  ...
  const [bigesstIncome, setBigestIncome] = useState<Transaction>();
      ...
      <div className="flex flex-col gap-6 h-full mb-6 w-2/8">
        <ColorCard>
          ...
          >
            ...
            <span className="font-semibold text-black/30">This month</span>
          </motion.header>
        ...
        <SmallCard>
          ...
          <div className="flex gap-4 items-center">
            <CircularProgress
              size={110}
              color={bigesstIncome?.category.color ?? "#ff8d35"}
              percentage={
                bigesstIncome
                  ? parseFloat(
                      FormatNumber((bigesstIncome.amount / incomes) * 100)
                    )
                  : 0
              }
            />
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-0">
                <span className="font-bold text-neutral-600 text-3xl">
                  {bigesstIncome ? bigesstIncome.name : "???"}
                </span>
              ...
              <span className="font-bold text-primary text-4xl">
                ${bigesstIncome ? FormatNumber(bigesstIncome.amount) : "---"}
              </span>
            </div>
          </div>
        </SmallCard>
